            ...
            <div class="col-sm-12">
                <section class="panel panel-default">
                    <div class="panel-body">
                    	<form role="form" class="form-news form-horizontal" method="POST" action="" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <img src="../../../upload/news/{{(isset($data['0']->img_path) && $data['0']->img_path!='')?$data['0']->img_path:"img-preview.png"}}" class="preview-img" width="200px" height="200px">
