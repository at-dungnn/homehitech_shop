                    ...
                    <div class="panel-body">
                    	<form role="form" class="form-product form-horizontal" method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="so_luong" class="so_luong form-control" maxlength="50"  value="{!!$data['0']->so_luong or ''!!}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <img src="../../../upload/product/{{(isset($data['0']->img_path) && $data['0']->img_path!='')?$data['0']->img_path:"img-preview.png"}}" class="preview-img" width="200px" height="200px">
